"""Wrapper for `kubectl get -o yaml`."""
...
def run_get_yaml(resource: str, name: str, namespace: str) -> str:
    """Fetch manifest YAML for a resource instance."""
    cmd = ["kubectl", "get", resource, name, "-n", namespace, "-o", "yaml"]
